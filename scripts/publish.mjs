...
const packages = [
	{ directory: "packages/science", name: "@shying/ds-science" },
	{ directory: "packages/server", name: "@shying/deepscience" },
];

const dryRun = process.argv.includes("--dry-run");
const unknownArgs = process.argv.slice(2).filter((arg) => arg !== "--dry-run");
const provenance = process.env.GITHUB_ACTIONS === "true" || process.env.NPM_CONFIG_PROVENANCE === "true";
...
console.log(`Publishing DeepScience package set${dryRun ? " (dry run)" : ""}\n`);
