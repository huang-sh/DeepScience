---
name: biomarker-uspto
description: "Search USPTO patent, trademark, examination-history, assignment, citation, and office-action APIs for biomedical intellectual-property evidence."
category: literature/patents
license: Mixed
metadata:
  access-mode: remote
  database: uspto
...
2. Obtain the exact package inventory with `catalog.py files biomarker-uspto` before opening files.
