...
### <resource-dir>/scripts/query_clinicaltrials.py
...
```bash
python3 <resource-dir>/scripts/query_clinicaltrials.py
```
...
For complete technical details, see `<resource-dir>/references/api_reference.md`.
