---
name: biomarker-clinicaltrials
description: "Search ClinicalTrials.gov API v2 by condition, intervention, location, phase, status, sponsor, or identifier and retrieve structured trial records."
category: literature/clinical-trials
license: Mixed
metadata:
  access-mode: remote
...
2. Obtain the exact package inventory with `catalog.py files biomarker-clinicaltrials` before opening files.
