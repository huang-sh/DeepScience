---
name: biomarker-azimuth
description: "Use the bundled Azimuth biomarker resource for Cellular landscape, cell type, General database. Discover and read 4 local reference/data files on demand without loading the full collection into context."
...
# Azimuth Local Biomarker Resource

## Overview

Use DeepScience's bundled Azimuth collection for tasks involving Cellular landscape, cell type, General database. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs Azimuth data or falls under **Cellular landscape / cell type / General database**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated Azimuth material in the Cellular landscape / cell type / General database collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-type/general-database/biomarker-azimuth/assets`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-type/general-database/biomarker-azimuth/references`
- **Indexed local files:** 4
- **Combined size:** 0.61 MiB
- **Formats:** .csv, .md
...
- **Database website:** https://azimuth.hubmapconsortium.org/
- **Citation:** https://www.cell.com/cell/fulltext/S0092-8674(21)00583-3
