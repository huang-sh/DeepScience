---
name: biomarker-cellxgene-census
description: "Query CELLxGENE Census expression and metadata across curated tissues, diseases, organisms, cell types, studies, and population-scale single-cell atlases."
category: biological-knowledge/cellular-landscape/cell-type/general-database
license: Mixed
metadata:
  access-mode: remote
  database: cellxgene-census
---

# biomarker-cellxgene-census
...
2. Obtain the exact package inventory with `catalog.py files biomarker-cellxgene-census` before opening files.
