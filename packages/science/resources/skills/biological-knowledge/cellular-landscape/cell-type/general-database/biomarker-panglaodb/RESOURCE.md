---
name: biomarker-panglaodb
description: "Use the bundled PanglaoDB biomarker resource for Cellular landscape, cell type, General database. Discover and read 4 local reference/data files on demand without loading the full collection into context."
...
# PanglaoDB Local Biomarker Resource

## Overview

Use DeepScience's bundled PanglaoDB collection for tasks involving Cellular landscape, cell type, General database. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs PanglaoDB data or falls under **Cellular landscape / cell type / General database**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated PanglaoDB material in the Cellular landscape / cell type / General database collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-type/general-database/biomarker-panglaodb/assets`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-type/general-database/biomarker-panglaodb/references`
- **Indexed local files:** 4
- **Combined size:** 1.17 MiB
- **Formats:** .md, .tsv
...
- **Database website:** https://panglaodb.se/
- **Citation:** https://academic.oup.com/database/article/doi/10.1093/database/baz046/5427041
