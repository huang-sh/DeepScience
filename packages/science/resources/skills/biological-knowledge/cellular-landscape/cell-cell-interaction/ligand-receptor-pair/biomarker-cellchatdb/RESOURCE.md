---
name: biomarker-cellchatdb
description: "Use the bundled CellChatDB biomarker resource for human, mouse, zebrafish. Discover and read 5 local reference/data files on demand without loading the full collection into context."
...
# CellChatDB Local Biomarker Resource

## Overview

Use DeepScience's bundled CellChatDB collection for tasks involving human, mouse, zebrafish. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs CellChatDB data or falls under **Cellular landscape / cell-cell interaction / ligand-receptor pair**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.
...
- **Data directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-cell-interaction/ligand-receptor-pair/biomarker-cellchatdb/assets/CellChatDB`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-cell-interaction/ligand-receptor-pair/biomarker-cellchatdb/references`
- **Indexed local files:** 5
- **Combined size:** 6.61 MiB
- **Formats:** .md, .tsv
...
- **Database website:** http://www.cellchat.org/
- **Citation:** https://www.nature.com/articles/s41467-021-21246-9
