---
name: biomarker-connectomedb
description: "Use the bundled ConnectomeDB biomarker resource for Cellular landscape, cell-cell interaction, ligand-receptor pair. Discover and read 16 local reference/data files on demand without loading the full collection into context."
category: biological-knowledge/cellular-landscape/cell-cell-interaction/ligand-receptor-pair
license: Unknown
metadata:
  access-mode: local
  database: "ConnectomeDB"
  collection: biomarker
  local-files: 16
  generated-from: resource_tree.json
---

# ConnectomeDB Local Biomarker Resource

## Overview

Use DeepScience's bundled ConnectomeDB collection for tasks involving Cellular landscape, cell-cell interaction, ligand-receptor pair. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs ConnectomeDB data or falls under **Cellular landscape / cell-cell interaction / ligand-receptor pair**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated ConnectomeDB material in the Cellular landscape / cell-cell interaction / ligand-receptor pair collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-cell-interaction/ligand-receptor-pair/biomarker-connectomedb/assets/ConnectomeDB`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-cell-interaction/ligand-receptor-pair/biomarker-connectomedb/references`
- **Indexed local files:** 16
- **Combined size:** 17.0 MiB
- **Formats:** .csv, .md
...
- **Database website:** https://connectomedb.org
- **Citation:** https://doi.org/10.1093/nar/gkaf1108
