---
name: biomarker-cellphonedb
description: "Use the bundled cellphoneDB biomarker resource for Cellular landscape, cell-cell interaction, ligand-receptor pair. Discover and read 3 local reference/data files on demand without loading the full collection into context."
...
# cellphoneDB Local Biomarker Resource

## Overview

Use DeepScience's bundled cellphoneDB collection for tasks involving Cellular landscape, cell-cell interaction, ligand-receptor pair. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs cellphoneDB data or falls under **Cellular landscape / cell-cell interaction / ligand-receptor pair**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated cellphoneDB material in the Cellular landscape / cell-cell interaction / ligand-receptor pair collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-cell-interaction/ligand-receptor-pair/biomarker-cellphonedb/assets`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/cellular-landscape/cell-cell-interaction/ligand-receptor-pair/biomarker-cellphonedb/references`
- **Indexed local files:** 3
- **Combined size:** 0.47 MiB
- **Formats:** .csv, .md
...
- **Database website:** https://www.cellphonedb.org/
- **Citation:** https://www.nature.com/articles/s41596-024-01137-1
