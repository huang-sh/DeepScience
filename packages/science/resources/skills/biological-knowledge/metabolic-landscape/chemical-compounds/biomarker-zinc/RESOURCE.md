---
name: biomarker-zinc
description: "Search ZINC purchasable compounds by identifier or structure and retrieve docking-ready structures and analogs for virtual screening."
...
2. Obtain the exact package inventory with `catalog.py files biomarker-zinc` before opening files.
