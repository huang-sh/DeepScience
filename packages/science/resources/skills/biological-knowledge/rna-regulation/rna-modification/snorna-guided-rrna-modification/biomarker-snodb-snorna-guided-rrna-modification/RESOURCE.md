---
name: biomarker-snodb-snorna-guided-rrna-modification
description: "Use the bundled snoDB biomarker resource for RNA Regulation, RNA modification, snoRNA-guided rRNA modification. Discover and read 4 local reference/data files on demand without loading the full collection into context."
category: biological-knowledge/rna-regulation/rna-modification/snorna-guided-rrna-modification
license: Unknown
metadata:
  access-mode: local
  database: "snoDB"
...
# snoDB Local Biomarker Resource

## Overview

Use DeepScience's bundled snoDB collection for tasks involving RNA Regulation, RNA modification, snoRNA-guided rRNA modification. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs snoDB data or falls under **RNA Regulation / RNA modification / snoRNA-guided rRNA modification**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated snoDB material in the RNA Regulation / RNA modification / snoRNA-guided rRNA modification collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/rna-modification/snorna-guided-rrna-modification/biomarker-snodb-snorna-guided-rrna-modification/assets`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/rna-modification/snorna-guided-rrna-modification/biomarker-snodb-snorna-guided-rrna-modification/references`
- **Indexed local files:** 4
- **Combined size:** 0.21 MiB
- **Formats:** .md, .tsv
...
- **Database website:** https://bioinfoscottgroup.med.usherbrooke.ca/snoDB/
- **Citation:** https://doi.org/10.1093/nar/gkac835
