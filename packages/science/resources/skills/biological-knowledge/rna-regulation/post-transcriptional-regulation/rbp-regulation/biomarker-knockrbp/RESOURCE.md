---
name: biomarker-knockrbp
description: "Use the bundled KnockRBP biomarker resource for RBP annotation, RBP-APA regulations, RBP-AS regulations, RBP-gene regulations, RBP-miRNA regulations, RBP-RNA-Editing regulations, RBP-Translation regulations. Discover and read 161 local reference/data files on demand without loading the full collection into context."
category: biological-knowledge/rna-regulation/post-transcriptional-regulation/rbp-regulation
license: Unknown
metadata:
  access-mode: local
  database: "KnockRBP"
...
# KnockRBP Local Biomarker Resource

## Overview

Use DeepScience's bundled KnockRBP collection for tasks involving RBP annotation, RBP-APA regulations, RBP-AS regulations, RBP-gene regulations, RBP-miRNA regulations, RBP-RNA-Editing regulations, RBP-Translation regulations. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs KnockRBP data or falls under **RNA Regulation / Post-transcriptional Regulation / RBP Regulation**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.
...
- RBP-APA regulations
- RBP-AS regulations
- RBP-gene regulations
- RBP-miRNA regulations
- RBP-RNA-Editing regulations
- RBP-Translation regulations

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/post-transcriptional-regulation/rbp-regulation/biomarker-knockrbp/assets/KnockRBP`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/post-transcriptional-regulation/rbp-regulation/biomarker-knockrbp/references`
- **Indexed local files:** 161
- **Combined size:** 22.5 MiB
- **Formats:** .csv, .md
...
- **Database website:** https://knockrbp.xu-bioinfo.com
