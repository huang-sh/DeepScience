---
name: biomarker-animaltfdb-4-0
description: "Use the bundled AnimalTFDB 4.0 biomarker resource for RNA Regulation, transcriptional regulation, transcription factor. Discover and read 22 local reference/data files on demand without loading the full collection into context."
category: biological-knowledge/rna-regulation/transcriptional-regulation/transcription-factor
license: Unknown
metadata:
  access-mode: local
  database: "AnimalTFDB 4.0"
  collection: biomarker
  local-files: 22
  generated-from: resource_tree.json
---

# AnimalTFDB 4.0 Local Biomarker Resource

## Overview

Use DeepScience's bundled AnimalTFDB 4.0 collection for tasks involving RNA Regulation, transcriptional regulation, transcription factor. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs AnimalTFDB 4.0 data or falls under **RNA Regulation / transcriptional regulation / transcription factor**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated AnimalTFDB 4.0 material in the RNA Regulation / transcriptional regulation / transcription factor collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/transcriptional-regulation/transcription-factor/biomarker-animaltfdb-4-0/assets/AnimalTFDB4`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/transcriptional-regulation/transcription-factor/biomarker-animaltfdb-4-0/references`
- **Indexed local files:** 22
- **Combined size:** 2.45 MiB
- **Formats:** .md, .txt
...
- **Database website:** http://bioinfo.life.hust.edu.cn/AnimalTFDB4/
- **Citation:** https://doi.org/10.1093/nar/gkac907
