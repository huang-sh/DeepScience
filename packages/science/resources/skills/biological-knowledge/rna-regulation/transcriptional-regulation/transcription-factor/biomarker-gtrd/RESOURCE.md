---
name: biomarker-gtrd
description: "Use the bundled GTRD biomarker resource for RNA Regulation, transcriptional regulation, transcription factor. Discover and read 4 local reference/data files on demand without loading the full collection into context."
...
# GTRD Local Biomarker Resource

## Overview

Use DeepScience's bundled GTRD collection for tasks involving RNA Regulation, transcriptional regulation, transcription factor. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs GTRD data or falls under **RNA Regulation / transcriptional regulation / transcription factor**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated GTRD material in the RNA Regulation / transcriptional regulation / transcription factor collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/transcriptional-regulation/transcription-factor/biomarker-gtrd/assets/GTRD`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/transcriptional-regulation/transcription-factor/biomarker-gtrd/references`
- **Indexed local files:** 4
- **Combined size:** 4.10 MiB
- **Formats:** .gmt, .json, .md
...
- **Database website:** http://gtrd.biouml.org/
- **Citation:** https://doi.org/10.1093/nar/gkaa1057
