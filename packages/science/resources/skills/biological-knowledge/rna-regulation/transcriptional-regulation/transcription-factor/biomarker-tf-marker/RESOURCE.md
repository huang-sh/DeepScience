---
name: biomarker-tf-marker
description: "Use the bundled TF-Marker biomarker resource for RNA Regulation, transcriptional regulation, transcription factor. Discover and read 7 local reference/data files on demand without loading the full collection into context."
...
# TF-Marker Local Biomarker Resource

## Overview

Use DeepScience's bundled TF-Marker collection for tasks involving RNA Regulation, transcriptional regulation, transcription factor. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs TF-Marker data or falls under **RNA Regulation / transcriptional regulation / transcription factor**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated TF-Marker material in the RNA Regulation / transcriptional regulation / transcription factor collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/transcriptional-regulation/transcription-factor/biomarker-tf-marker/assets/TF-marker`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/rna-regulation/transcriptional-regulation/transcription-factor/biomarker-tf-marker/references`
- **Indexed local files:** 7
- **Combined size:** 2.38 MiB
- **Formats:** .md, .txt
...
- **Database website:** http://bio.liclab.net/TF-Marker/
- **Citation:** https://academic.oup.com/nar/article/50/D1/D402/6431821
