---
name: biomarker-gwas-catalog
description: "Query the NHGRI-EBI GWAS Catalog for variant-trait associations, studies, mapped genes, p-values, ancestry, and available summary statistics."
...
2. Obtain the exact package inventory with `catalog.py files biomarker-gwas-catalog` before opening files.
