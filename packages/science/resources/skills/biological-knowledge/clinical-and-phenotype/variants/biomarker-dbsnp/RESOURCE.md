---
name: biomarker-dbsnp
description: "Resolve dbSNP rsIDs and merge histories and convert among rsID, SPDI, HGVS, and VCF representations using current NCBI records."
...
2. Obtain the exact package inventory with `catalog.py files biomarker-dbsnp` before opening files.
