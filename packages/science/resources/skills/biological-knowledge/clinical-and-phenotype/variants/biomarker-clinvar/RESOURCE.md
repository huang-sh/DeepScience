---
name: biomarker-clinvar
description: "Query ClinVar clinical significance, review status, submitter evidence, ClinGen expert-panel curation, and germline or somatic interpretations."
...
2. Obtain the exact package inventory with `catalog.py files biomarker-clinvar` before opening files.
