...
Refer to `<resource-dir>/references/target_annotations.md` for detailed information about all target features.
...
Refer to `<resource-dir>/references/evidence_types.md` for detailed descriptions of all evidence types and interpretation guidelines.
...
**For custom queries beyond the provided helper functions**, use the GraphQL API directly or modify `<resource-dir>/scripts/query_opentargets.py`.
...
Refer to `<resource-dir>/references/api_reference.md` for:
...
**<resource-dir>/scripts/query_opentargets.py**
...
**<resource-dir>/references/api_reference.md**
...
**<resource-dir>/references/evidence_types.md**
...
**<resource-dir>/references/target_annotations.md**
