---
name: biomarker-biomedical-fact-lookup
description: "Verify bounded biomedical facts and multiple-choice claims against authoritative public databases rather than answering database-dependent questions from memory."
category: biological-knowledge/clinical-and-phenotype/clinical-evidence
license: Mixed
metadata:
  access-mode: remote
  database: biomedical-fact-lookup
---

# biomarker-biomedical-fact-lookup
...
2. Obtain the exact package inventory with `catalog.py files biomarker-biomedical-fact-lookup` before opening files.
