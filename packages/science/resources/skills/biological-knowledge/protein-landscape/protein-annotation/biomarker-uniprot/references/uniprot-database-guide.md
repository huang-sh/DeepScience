...
- PDB, AlphaFoldDB
- KEGG, GO terms
- And many more (see `/<resource-dir>/references/id_mapping_databases.md`)
...
See `/<resource-dir>/references/api_fields.md` for complete field list.

## Python Implementation

For programmatic access, use the provided helper script `<resource-dir>/scripts/uniprot_client.py` which implements:
...
See `/<resource-dir>/references/query_syntax.md` for comprehensive syntax documentation.
