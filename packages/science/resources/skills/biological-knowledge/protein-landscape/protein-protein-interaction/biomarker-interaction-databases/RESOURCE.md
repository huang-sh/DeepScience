---
name: biomarker-interaction-databases
description: "Select and query complementary interaction resources including STRING, BioGRID, IntAct, SIGNOR, Reactome, HuRI, HuMAP, OmniPath, ConsensusPathDB, and DIP."
category: biological-knowledge/protein-landscape/protein-protein-interaction
license: Mixed
metadata:
  access-mode: remote
  database: interaction-databases
---

# biomarker-interaction-databases
...
2. Obtain the exact package inventory with `catalog.py files biomarker-interaction-databases` before opening files.
