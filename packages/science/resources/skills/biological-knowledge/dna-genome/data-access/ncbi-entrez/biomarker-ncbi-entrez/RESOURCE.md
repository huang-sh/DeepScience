---
name: biomarker-ncbi-entrez
description: "Search, link, fetch, and batch-download records across NCBI Entrez databases with history-server pagination, rate limiting, retries, and integrity checks."
category: biological-knowledge/dna-genome/data-access/ncbi-entrez
license: Mixed
metadata:
  access-mode: remote
...
2. Obtain the exact package inventory with `catalog.py files biomarker-ncbi-entrez` before opening files.
