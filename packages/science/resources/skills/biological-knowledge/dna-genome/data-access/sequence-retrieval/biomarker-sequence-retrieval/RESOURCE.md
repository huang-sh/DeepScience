---
name: biomarker-sequence-retrieval
description: "Retrieve DNA, RNA, transcript, and protein sequences across NCBI and ENA with accession disambiguation and curated-record preference."
category: biological-knowledge/dna-genome/data-access/sequence-retrieval
license: Mixed
metadata:
  access-mode: remote
...
2. Obtain the exact package inventory with `catalog.py files biomarker-sequence-retrieval` before opening files.
