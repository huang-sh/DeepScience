...
1. Use the `<resource-dir>/scripts/query_gene.py` script with E-utilities ESearch
...
1. Use `<resource-dir>/scripts/fetch_gene_data.py` with the Datasets API for comprehensive data
2. Alternatively, use `<resource-dir>/scripts/query_gene.py` with E-utilities EFetch for specific formats
...
1. Use `<resource-dir>/scripts/batch_gene_lookup.py` for efficient batch processing
...
```bash
python <resource-dir>/scripts/query_gene.py --search "BRCA1" --organism "human"
python <resource-dir>/scripts/query_gene.py --id 672 --format json
python <resource-dir>/scripts/query_gene.py --search "insulin[gene] AND diabetes[disease]"
```
...
```bash
python <resource-dir>/scripts/fetch_gene_data.py --gene-id 672
python <resource-dir>/scripts/fetch_gene_data.py --symbol BRCA1 --taxon human
python <resource-dir>/scripts/fetch_gene_data.py --symbol TP53 --taxon "Homo sapiens" --output json
```
...
```bash
python <resource-dir>/scripts/batch_gene_lookup.py --file gene_list.txt --organism human
python <resource-dir>/scripts/batch_gene_lookup.py --ids 672,7157,5594 --output results.json
```
...
- `<resource-dir>/references/api_reference.md` - Comprehensive API documentation for E-utilities and Datasets API
- `<resource-dir>/references/common_workflows.md` - Additional examples and use case patterns
