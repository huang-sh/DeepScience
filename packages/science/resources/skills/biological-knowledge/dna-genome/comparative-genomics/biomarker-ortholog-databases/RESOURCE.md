---
name: biomarker-ortholog-databases
description: "Retrieve and compare precomputed ortholog calls from Ensembl Compara, OrthoDB, OMA, eggNOG, PANTHER, KEGG Orthology, and related resources."
category: biological-knowledge/dna-genome/comparative-genomics
license: Mixed
metadata:
  access-mode: remote
  database: ortholog-databases
---

# biomarker-ortholog-databases
...
2. Obtain the exact package inventory with `catalog.py files biomarker-ortholog-databases` before opening files.
