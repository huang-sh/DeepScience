---
name: biomarker-msigdb-signature
description: "Use the bundled msigdb H: Hallmark gene sets biomarker resource for Functional signatures, signature. Discover and read 4 local reference/data files on demand without loading the full collection into context."
...
# msigdb H: Hallmark gene sets Local Biomarker Resource

## Overview

Use DeepScience's bundled msigdb H: Hallmark gene sets collection for tasks involving Functional signatures, signature. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs msigdb H: Hallmark gene sets data or falls under **Functional signatures / signature**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated msigdb H: Hallmark gene sets material in the Functional signatures / signature collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/functional-signatures/signature/biomarker-msigdb-signature/assets/hallmark`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/functional-signatures/signature/biomarker-msigdb-signature/references`
- **Indexed local files:** 4
- **Combined size:** 0.12 MiB
- **Formats:** .gmt, .json, .md
...
- **Database website:** https://www.gsea-msigdb.org/gsea/msigdb/
- **Citation:** https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4707969/
