---
name: biomarker-wikipathways
description: "Use the bundled WikiPathways biomarker resource for Functional signatures, pathway, WikiPathways. Discover and read 19 local reference/data files on demand without loading the full collection into context."
category: biological-knowledge/functional-signatures/pathway/wikipathways
license: Unknown
metadata:
  access-mode: local
...
# WikiPathways Local Biomarker Resource

## Overview

Use DeepScience's bundled WikiPathways collection for tasks involving Functional signatures, pathway, WikiPathways. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs WikiPathways data or falls under **Functional signatures / pathway / WikiPathways**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated WikiPathways material in the Functional signatures / pathway / WikiPathways collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/functional-signatures/pathway/wikipathways/biomarker-wikipathways/assets/WikiPathways`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/functional-signatures/pathway/wikipathways/biomarker-wikipathways/references`
- **Indexed local files:** 19
- **Combined size:** 0.66 MiB
- **Formats:** .gmt, .md
...
- **Database website:** https://www.wikipathways.org/
- **Citation:** https://doi.org/10.1093/nar/gkad960
