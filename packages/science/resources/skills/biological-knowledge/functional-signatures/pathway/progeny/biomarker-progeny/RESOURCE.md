---
name: biomarker-progeny
description: "Use the bundled PROGENy biomarker resource for Functional signatures, pathway, PROGENy. Discover and read 4 local reference/data files on demand without loading the full collection into context."
category: biological-knowledge/functional-signatures/pathway/progeny
license: Unknown
metadata:
  access-mode: local
  database: "PROGENy"
...
# PROGENy Local Biomarker Resource

## Overview

Use DeepScience's bundled PROGENy collection for tasks involving Functional signatures, pathway, PROGENy. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs PROGENy data or falls under **Functional signatures / pathway / PROGENy**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated PROGENy material in the Functional signatures / pathway / PROGENy collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/functional-signatures/pathway/progeny/biomarker-progeny/assets/PROGENy`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/functional-signatures/pathway/progeny/biomarker-progeny/references`
- **Indexed local files:** 4
- **Combined size:** 6.63 MiB
- **Formats:** .csv, .md
...
- **Database website:** https://saezlab.github.io/progeny/
- **Citation:** https://www.nature.com/articles/s41467-017-02391-6
