---
name: biomarker-3ca
description: "Use the bundled 3CA biomarker resource for Functional signatures, program, Cancer cell program. Discover and read 4 local reference/data files on demand without loading the full collection into context."
category: biological-knowledge/functional-signatures/program/cancer-cell-program
license: Unknown
metadata:
  access-mode: local
  database: "3CA"
...
# 3CA Local Biomarker Resource

## Overview

Use DeepScience's bundled 3CA collection for tasks involving Functional signatures, program, Cancer cell program. This skill describes how to discover and read the local snapshot; it does not preload database contents.

## When to Use This Skill

Load this skill when a task needs 3CA data or falls under **Functional signatures / program / Cancer cell program**. Prefer the bundled snapshot for reproducible offline analysis. Use the official database only when the task requires newer records or functionality absent from the local files.

## Available Content

- Curated 3CA material in the Functional signatures / program / Cancer cell program collection

## Local Data

- **Data directory:** `packages/science/resources/skills/biological-knowledge/functional-signatures/program/cancer-cell-program/biomarker-3ca/assets/3CA`
- **Reference directory:** `packages/science/resources/skills/biological-knowledge/functional-signatures/program/cancer-cell-program/biomarker-3ca/references`
- **Indexed local files:** 4
- **Combined size:** 0.43 MiB
- **Formats:** .csv, .md
...
- **Database website:** https://www.weizmann.ac.il/sites/3CA/
- **Citation:** https://www.nature.com/articles/s41586-023-06130-4
