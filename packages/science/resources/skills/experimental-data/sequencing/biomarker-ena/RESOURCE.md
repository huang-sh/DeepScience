---
name: biomarker-ena
description: "Search and retrieve European Nucleotide Archive sequences, reads, assemblies, analyses, and metadata through Portal, Browser, and file endpoints."
...
2. Obtain the exact package inventory with `catalog.py files biomarker-ena` before opening files.
