---
name: biomarker-geo
description: "Search and retrieve NCBI GEO expression studies, samples, platforms, processed matrices, supplementary files, and linked raw sequencing accessions."
...
2. Obtain the exact package inventory with `catalog.py files biomarker-geo` before opening files.
