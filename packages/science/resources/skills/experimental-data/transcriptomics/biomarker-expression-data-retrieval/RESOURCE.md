---
name: biomarker-expression-data-retrieval
description: "Find and assess expression and omics datasets across ArrayExpress, BioStudies, GEO, and related repositories by organism, tissue, condition, and study design."
category: experimental-data/transcriptomics
license: Mixed
metadata:
  access-mode: remote
  database: expression-data-retrieval
---

# biomarker-expression-data-retrieval
...
2. Obtain the exact package inventory with `catalog.py files biomarker-expression-data-retrieval` before opening files.
