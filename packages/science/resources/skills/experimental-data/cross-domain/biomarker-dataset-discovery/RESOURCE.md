---
name: biomarker-dataset-discovery
description: "Map scientific questions to suitable public cohorts, studies, repositories, and dataset designs and evaluate candidate datasets before retrieval."
category: experimental-data/cross-domain
license: Mixed
metadata:
  access-mode: remote
  database: dataset-discovery
---

# biomarker-dataset-discovery
...
2. Obtain the exact package inventory with `catalog.py files biomarker-dataset-discovery` before opening files.
